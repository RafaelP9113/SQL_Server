...
-------------------------------------------------------------------------- PIS SAIDA -------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
EMISSAO,MATRIZ_FISCAL,FILIAL,NOME_CLIFOR,NF_SAIDA,SERIE_NF,CHAVE_NFE,CTB_LANCAMENTO,CODIGO_FISCAL_OPERACAO,CONTA_CONTABIL_ITEM,DESC_CONTA,CONTA_CONTABIL_IMPOSTO,ID_IMPOSTO,BASE_IMPOSTO,TAXA_IMPOSTO,VALOR_IMPOSTO
...
from vw_znz_pis_saida

create view vw_znz_pis_saida as
